                        ...
                        <div>
                          ...
                          <div className="space-y-2">
                            {detail.income_entries.map(entry => (
                              <div key={entry.id} className="flex items-center justify-between px-3 py-2 bg-green-50 rounded-lg text-sm">
                                <div>
                        ...
                        <div>
                          ...
                          <div className="space-y-2">
                            {detail.expense_entries.map(entry => (
                              <div key={entry.id} className="flex items-center justify-between px-3 py-2 bg-red-50 rounded-lg text-sm">
                                <div>
